...
function Ourteam() {
  return (
    <div className="w-[100%] ourTeam_page mt-[8rem]">
          ...
          <div className="team_people rounded-tl-[3rem] rounded-br-[3rem] shadow-xl">
            <div className="card">
              <div className="card_face card_front">
                ...
                <div className="text-black ml-2 text-2xl font-nohemi mt-3 h-16">Saiprasad Pandilwar</div>
              ...
              <div className="card_face card_back rounded-tl-[3rem] font-neue">
                <div className="content">
                  <div className="text-white text-md md:text-2xl font-bold">Saiprasad Pandilwar</div>
                  ...
                  <p className="text-sm md:text-xl mt-2">From that moment, MyPerro was born. Here, your &quot;perro&quot; is treated just like it is &quot;MyPerro&quot; with love, care, and all the attention they deserve.</p>
                </div>
                <div className="image-container">
                  <a href="https://www.google.com/">
                    <img className="mt-2" src="linkedin.png" alt="hi" height="20" width="20" />
                  </a>
                </div>
              </div>
            </div>
          ...
          <div className="team_people rounded-tl-[3rem] rounded-br-[3rem] shadow-xl">
            <div className="card">
              <div className="card_face card_front">
                ...
                <div className="text-black ml-2 text-2xl font-nohemi mt-3 h-16">Manan Vyas</div>
                <a href="https://www.google.com/">
                  <img className="ml-2 " src="linkedin.png" alt="hi" height="20" width="20" />
                </a>
              </div>
              <div className="card_face card_back rounded-tl-[3rem] font-neue">
                <div className="content">
                  <div className="text-white text-2xl font-bold">Manan Vyas</div>
                ...
                <div className="image-container">
                  <a href="https://www.google.com/">
                    <img src="linkedin.png" alt="hi" height="20" width="20" />
                  </a>
                </div>
              </div>
            </div>
          ...
          <div className="team_people rounded-tl-[3rem] rounded-br-[3rem] shadow-xl">
            <div className="card">
              ...
              <div className="card_face card_back rounded-tl-[3rem] font-neue">
                ...
                <div className="image-container">
                  <a href="https://www.google.com/">
                    <img className='mt-3' src="linkedin.png" alt="hi" height="20" width="20" />
                  </a>
                </div>
              </div>
            </div>
