  ...
  return (
    <div className="w-[100%] ourTeam_page mt-[8rem]">
      <div id="ourTeam" className="flex flex-col">
        <div className="text-8xl md:text-6xl font-bold font-anta mt-10 h-15 mb-10 text-[#3C130E] font-nohemi">Our Team</div>
          ...
          <div className="team_people rounded-tl-[3rem] rounded-br-[3rem] shadow-xl">
            <div className="card">
              <div className="card_face card_front">
                ...
                <div className="text-black ml-2 text-2xl font-nohemi font-semibold mt-3 h-16">Manan Vyas</div>
                <a href="https://www.google.com/">
                  <img className="ml-2 " src="linkedin.png" alt="hi" height="20" width="20" />
                </a>
              </div>
          ...
          <div className="team_people rounded-tl-[3rem] rounded-br-[3rem] shadow-xl">
            <div className="card">
              <div className="card_face card_front">
                ...
                <div className="text-black ml-2 text-2xl font-nohemi font-semibold mt-3 h-16">Shivanshi Rawat</div>
                <a href="https://www.google.com/">
                  <img className="ml-2 " src="linkedin.png" alt="hi" height="20" width="20" />
                </a>
              </div>
          ...
          <div className="team_people rounded-tl-[3rem] rounded-br-[3rem] shadow-xl">
            <div className="card ">
              <div className="card_face card_front">
                ...
                <div className="text-black ml-2 text-2xl font-nohemi font-semibold mt-3 h-16">Komolika Chakroborthy</div>
                <a href="https://www.google.com/">
                  <img className="ml-2 " src="linkedin.png" alt="hi" height="20" width="20" />
                </a>
              </div>
