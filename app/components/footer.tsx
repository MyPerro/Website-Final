    ...
    return(
        <div className='flex flex-col footerpage'>
            ...
            <div className='flex flex-row px-20 pt-10'>
                <div className='text-4xl font-bold footerspace'><h1>Say Hello</h1></div>
                <div className='ml-4 flex flex-col footerspace'>
                    <div><input className='rounded-md footerwidth' type='email' placeholder='Your E-mail ID'/></div>
                    <div><input className='mt-5 rounded-md footerwidth' type='text' placeholder='Your Mobile No.'/></div>
                </div>
                <div>
                    <textarea className='rounded-md footerwidth footerspace' rows="3" placeholder='Message For Us'/>
                </div>
                <div>
