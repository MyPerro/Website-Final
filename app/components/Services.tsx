...
const Services = () => {
  return (
    <div className="flex flex-col md:flex-row justify-center items-center px-5 md:px-10 m-5 md:m-10 mb-9">
      <div className="w-full md:w-[40%] flex flex-col justify-center items-start space-y-4">
      ...
      <div className="w-full md:w-[60%] flex flex-col md:flex-row justify-center items-center md:pl-20">
