...
const Services = () => {
  ...
  return (
    <div className="flex flex-col md:flex-col xl:flex-row justify-center items-center px-2 md:px-[3rem] m-5 md:m-10 mb-9 min-h-[90vh]" id="our-services">
      <div className="w-full xl:w-[35%] flex flex-col justify-center items-start space-y-4">
        ...
        <button className="bg-[#FC6638] rounded-[2rem] shadow-2xl py-2 px-4 md:px-7 text-lg md:text-xl text-white font-semibold">Coming Soon</button>
      </div>
      <div className="w-full xl:w-[65%] flex flex-row md:flex-row justify-center items-center lg:pl-20 mt-10 lg:mt-0">
        <div className="w-full md:w-1/2 flex flex-col justify-center items-center md:items-start m-2 md:m-10 space-y-4">
          ...
          <p className="hidden md:block font-neue md:text-lg lg:text-md">Easily connect with certified, loving dog walkers through trusted platforms, ensuring your pets well-being and your peace of mind.`</p>
        </div>
        <div className="w-full md:w-1/2 flex flex-col justify-center items-center md:items-start m-2 md:m-10 space-y-4">
          ...
          <p className="hidden md:block font-neue md:text-lg lg:text-md">By setting the service standards of dog boarding high we ensure the hygiene, safety, security and comfort of every stay for our dogs.</p>
        </div>
      </div>
    </div>
  );
