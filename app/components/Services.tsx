...
const Services = () => {
  return (
    <div className="flex flex-col md:flex-row justify-center items-center px-5 md:px-[3rem] m-5 md:m-10 mb-9 min-h-[90vh]" id='our-services'>
      ...
      <div className="w-full md:w-[65%] flex flex-col md:flex-row justify-center items-center md:pl-20">
